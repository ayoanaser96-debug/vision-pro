    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm border-b">
        <div className="flex items-center justify-between px-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold text-primary">Vision Clinic</h1>
          </div>
          <div className="flex items-center gap-4">
      ...
      <div className="flex">
        ...
        <aside
          ...
          } lg:translate-x-0 fixed lg:static inset-y-0 left-0 z-50 w-64 bg-white shadow-lg border-r transition-transform duration-300 ease-in-out pt-20 lg:pt-0`}
        >
